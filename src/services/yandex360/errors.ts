...
function formatYandex360Error(details: Yandex360ApiErrorDetails): string {
  if (details.status === 401) {
    return "Яндекс 360 отклонил вход. Авторизуйте аккаунт заново или проверьте разрешения приложения.";
  }
  ...
  return `Ошибка Яндекс 360 ${details.status} ${details.statusText}. Подробности скрыты из диагностик; используйте redacted support bundle.`;
}
