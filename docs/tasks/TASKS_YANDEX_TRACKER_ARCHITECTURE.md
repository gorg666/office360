...
Статус: TASKS-001 architecture complete; TASKS-002 domain/cache implemented; TASKS-003 provider implemented; TASKS-004 mail create UI implemented; TASKS-005 lists/detail implemented; TASKS-006 sync/transitions/settings implemented; TASKS-007 final audit + assignee edit
